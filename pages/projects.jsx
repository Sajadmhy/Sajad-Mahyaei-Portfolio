      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.card}>
            <h2>Lolo Website</h2>
            <p>
              Developed a website with Next.js, TailwindCSS and Strapi for the
              CMS
            </p>
            <div className={styles.space}></div>
            <Image
          ...
          <div className={styles.card}>
            ...
            <div className={styles.btns}>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Sajadmhy/replit-careers-page"
          ...
          <div className={styles.card}>
            ...
            <div className={styles.btns}>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Sajadmhy/Chat-App"
                className={styles.code}
              >
                <button>Code</button>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://magical-cranachan-86bddd.netlify.app/"
                className={styles.preview}
              >
                <button>Preview</button>
              </a>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.btns}>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Sajadmhy/gmail-clone"
                className={styles.code}
              >
                <button>Code</button>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://main--deluxe-churros-437829.netlify.app/"
                className={styles.preview}
              >
                <button>Preview</button>
              </a>
          ...
          <div className={styles.card}>
            ...
            <p>
              A CRUD Application created with Next.js, MaterialUI, Nest.js and
              MongoDB
            </p>
            <div className={styles.space}></div>
            <Image
            ...
            <div className={styles.btns}>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Sajadmhy/WW-client"
                className={styles.code}
              >
                <button>Code</button>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://stately-zabaione-b81df0.netlify.app/"
                className={styles.preview}
              >
                <button>Preview</button>
              </a>
          ...
          <div className={styles.card}>
            ...
            <p>
              An app to save a user&apos;s location with React.js, ContextAPI
              and Leaflet.js
            </p>
            <div className={styles.space}></div>
            <Image
            ...
            <div className={styles.btns}>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Sajadmhy/location-sharing-modal"
                className={styles.code}
              >
                <button>Code</button>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://sajadmhy.github.io/location-sharing-modal"
                className={styles.preview}
              >
                <button>Preview</button>
              </a>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.btns}>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Sajadmhy/Battleship"
                className={styles.code}
              >
                <button>Code</button>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://sajadmhy.github.io/Battleship/"
                className={styles.preview}
              >
                <button>Preview</button>
              </a>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.btns}>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/Sajadmhy/memory-card-game"
                className={styles.code}
              >
                <button>Code</button>
              </a>
              <a
                target="_blank"
                rel="noreferrer"
                href="https://sajadmhy.github.io/memory-card-game/"
                className={styles.preview}
              >
                <button>Preview</button>
              </a>
